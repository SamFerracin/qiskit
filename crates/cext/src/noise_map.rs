...
use qiskit_accelerate::noise_map::{BitTermSam, NoiseMapSam, SparseTermViewSam};
...
use pyo3::{Py, Python};
#[cfg(feature = "python_binding")]
use qiskit_accelerate::noise_map::PyNoiseMapSam;
...
impl TryFrom<&CSparseTerm> for SparseTermViewSam<'_> {
...
pub extern "C" fn qk_obs_zero_Sam(num_qubits: u32) -> *mut NoiseMapSam {
    let obs = NoiseMapSam::zero(num_qubits);
...
#[no_mangle]
#[cfg(feature = "cbinding")]
pub extern "C" fn qk_obs_identity_Sam(num_qubits: u32) -> *mut NoiseMapSam {
    let obs = NoiseMapSam::identity(num_qubits);
    Box::into_raw(Box::new(obs))
}
...
#[no_mangle]
#[cfg(feature = "cbinding")]
pub unsafe extern "C" fn qk_obs_new_Sam(
    num_qubits: u32,
    num_terms: u64,
    num_bits: u64,
    ...
    let result = NoiseMapSam::new(num_qubits, coeffs, bit_terms, indices, boundaries);
    match result {
...
#[no_mangle]
#[cfg(feature = "cbinding")]
pub unsafe extern "C" fn qk_obs_free_Sam(obs: *mut NoiseMapSam) {
    if !obs.is_null() {
        if !obs.is_aligned() {
...
#[no_mangle]
#[cfg(feature = "cbinding")]
pub unsafe extern "C" fn qk_obs_add_term_Sam(
    obs: *mut NoiseMapSam,
...
#[no_mangle]
#[cfg(feature = "cbinding")]
pub unsafe extern "C" fn qk_obs_term_Sam(
    obs: *mut NoiseMapSam,
    index: u64,
    out: *mut CSparseTerm,
) -> ExitCode {
...
#[no_mangle]
#[cfg(feature = "cbinding")]
pub unsafe extern "C" fn qk_obs_num_terms_Sam(obs: *const NoiseMapSam) -> usize {
...
#[no_mangle]
#[cfg(feature = "cbinding")]
pub unsafe extern "C" fn qk_obs_num_qubits_Sam(obs: *const NoiseMapSam) -> u32 {
    // SAFETY: Per documentation, the pointer is non-null and aligned.
    let obs = unsafe { const_ptr_as_ref(obs) };
...
#[no_mangle]
#[cfg(feature = "cbinding")]
pub unsafe extern "C" fn qk_obs_len_Sam(obs: *const NoiseMapSam) -> usize {
    // SAFETY: Per documentation, the pointer is non-null and aligned.
    let obs = unsafe { const_ptr_as_ref(obs) };
...
#[no_mangle]
#[cfg(feature = "cbinding")]
pub unsafe extern "C" fn qk_obs_coeffs_Sam(obs: *mut NoiseMapSam) -> *mut Complex64 {
    // SAFETY: Per documentation, the pointer is non-null and aligned.
    let obs = unsafe { mut_ptr_as_ref(obs) };
...
#[no_mangle]
#[cfg(feature = "cbinding")]
pub unsafe extern "C" fn qk_obs_indices_Sam(obs: *mut NoiseMapSam) -> *mut u32 {
    // SAFETY: Per documentation, the pointer is non-null and aligned.
    let obs = unsafe { mut_ptr_as_ref(obs) };
...
#[no_mangle]
#[cfg(feature = "cbinding")]
pub unsafe extern "C" fn qk_obs_boundaries_Sam(obs: *mut NoiseMapSam) -> *mut usize {
    // SAFETY: Per documentation, the pointer is non-null and aligned.
    let obs = unsafe { mut_ptr_as_ref(obs) };
...
#[no_mangle]
#[cfg(feature = "cbinding")]
pub unsafe extern "C" fn qk_obs_bit_terms_Sam(obs: *mut NoiseMapSam) -> *mut BitTermSam {
    // SAFETY: Per documentation, the pointer is non-null and aligned.
    let obs = unsafe { mut_ptr_as_ref(obs) };
...
#[no_mangle]
#[cfg(feature = "cbinding")]
pub unsafe extern "C" fn qk_obs_multiply_Sam(
    obs: *const NoiseMapSam,
...
#[no_mangle]
#[cfg(feature = "cbinding")]
pub unsafe extern "C" fn qk_obs_add_Sam(
    left: *const NoiseMapSam,
    right: *const NoiseMapSam,
) -> *mut NoiseMapSam {
    // SAFETY: Per documentation, the pointers are non-null and aligned.
...
#[no_mangle]
#[cfg(feature = "cbinding")]
pub unsafe extern "C" fn qk_obs_compose_Sam(
    first: *const NoiseMapSam,
    second: *const NoiseMapSam,
) -> *mut NoiseMapSam {
    // SAFETY: Per documentation, the pointers are non-null and aligned.
...
#[no_mangle]
#[cfg(feature = "cbinding")]
pub unsafe extern "C" fn qk_obs_compose_map_Sam(
    first: *const NoiseMapSam,
    second: *const NoiseMapSam,
    qargs: *const u32,
) -> *mut NoiseMapSam {
...
#[no_mangle]
#[cfg(feature = "cbinding")]
pub unsafe extern "C" fn qk_obs_canonicalize_Sam(
    obs: *const NoiseMapSam,
    tol: f64,
) -> *mut NoiseMapSam {
    // SAFETY: Per documentation, the pointer is non-null and aligned.
...
#[no_mangle]
#[cfg(feature = "cbinding")]
pub unsafe extern "C" fn qk_obs_copy_Sam(obs: *const NoiseMapSam) -> *mut NoiseMapSam {
    // SAFETY: Per documentation, the pointer is non-null and aligned.
    let obs = unsafe { const_ptr_as_ref(obs) };
...
#[no_mangle]
#[cfg(feature = "cbinding")]
pub unsafe extern "C" fn qk_obs_equal_Sam(
    obs: *const NoiseMapSam,
    other: *const NoiseMapSam,
) -> bool {
    // SAFETY: Per documentation, the pointers are non-null and aligned.
    let obs = unsafe { const_ptr_as_ref(obs) };
...
#[no_mangle]
#[cfg(feature = "cbinding")]
pub unsafe extern "C" fn qk_obs_str_Sam(obs: *const NoiseMapSam) -> *mut c_char {
    // SAFETY: Per documentation, the pointer is non-null and aligned.
    let obs = unsafe { const_ptr_as_ref(obs) };
...
#[no_mangle]
#[cfg(feature = "cbinding")]
pub unsafe extern "C" fn qk_str_free_Sam(string: *mut c_char) {
    unsafe {
...
#[no_mangle]
#[cfg(feature = "cbinding")]
pub unsafe extern "C" fn qk_obsterm_str_Sam(term: *const CSparseTerm) -> *mut c_char {
    // SAFETY: Per documentation, the pointer is non-null and aligned.
    let term = unsafe { const_ptr_as_ref(term) };

    let view: SparseTermViewSam = term.try_into().unwrap();
...
#[no_mangle]
#[cfg(feature = "cbinding")]
pub extern "C" fn qk_bitterm_label_Sam(bit_term: BitTermSam) -> u8 {
    // BitTermSam is implemented as u8, which is calling convention compatible with C,
...
/// @ingroup QkObs
/// Convert to a Python-space ``NoiseMapSam``.
///
/// @param obs The C-space ``QkObs`` pointer.
///
/// @return A Python object representing the ``NoiseMapSam``.
///
/// # Safety
///
...
#[cfg(feature = "python_binding")]
#[cfg(feature = "cbinding")]
pub unsafe extern "C" fn qk_obs_to_python_Sam(obs: *const NoiseMapSam) -> *mut PyObject {
    // SAFETY: Per documentation, the pointer is non-null and aligned.
    let obs = unsafe { const_ptr_as_ref(obs) };
    let py_obs: PyNoiseMapSam = obs.clone().into();
